    ...
    return function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            module.exports = function(options) {
                ...
                Chart.prototype.internalVars = function() {
                    ...
                    width = this.meta.width = (options.width || Const.DEFAULT_WIDTH) - margin.left - margin.right;
                    height = this.meta.height = (options.height || Const.DEFAULT_HEIGHT) - margin.top - margin.bottom;
                ...
                Chart.prototype.buildTitle = function() {
                    var selection = this.root.selectAll("text.mg-chart-title").data(function(d) {
                        return [d.title].filter(Boolean)
                    });
                    selection.enter().append("text").attr("class", "mg-chart-title").attr("y", margin.top / 2).attr("x", margin.left + width / 2).attr("font-size", 25).attr("text-anchor", "middle").attr("alignment-baseline", "middle").text(options.title);
                ...
                Chart.prototype.buildCanvas = function() {
                    var self = this;
                    this.meta.zoomBehavior.x(xScale).y(yScale).scaleExtent([1e-5, Infinity]).on("zoom", function onZoom() {
                ...
                Chart.prototype.buildContent = function() {
                    ...
                    graphs.each(function(data, index) {
                        var options = data.graphOptions = data.graphOptions || {};
                        extendIf(options, {
                            type: "interval"
                        });
                        var sampler = options.type !== "interval" ? "builtIn" : "interval";
                        extendIf(options, {
                            sampler: sampler,
                            owner: self,
                            index: index
                        ...
                        d3.select(this).call(types[options.type](options));
                        d3.select(this).call(helpers(options))
                    })
                };
                ...
                Chart.prototype.setUpEventListeners = function() {
                    ...
                    var events = {
                        ...
                        "tip:update": function(x, y, index) {
                            ...
                            instance.root.select(".top-right-legend").attr("fill", Const.COLORS[index]).text(text.join(" "))
                        }
                    };
                    var all = {
                        mousemove: function() {
        ...
        2: [function(require, module, exports) {
            ...
            var evaluator = {
                ...
                eval: function(options, datum) {
                    ...
                    var nSamples = datum.samples || Math.min(globals.MAX_ITERATIONS, globals.DEFAULT_ITERATIONS || chart.meta.width * 2);
            ...
            module.exports = function(options) {
                ...
                derivative = function(selection) {
                    selection.each(function(d) {
                        ...
                        innerSelection.call(line(options));
        ...
        6: [function(require, module, exports) {
            ...
            function generateEvaluator(samplerName) {
                ...
                function evaluate(meta, property, variables) {
                    ...
                    return compiled.eval(extend({}, meta.scope, variables))
                }
                return evaluate
            }
            ...
            "built-in-math-eval": 21,
            extend: 53,
            "interval-arithmetic-eval": 55
        }],
        ...
        13: [function(require, module, exports) {
            ...
            function vector(chart, meta, range, nSamples) {
                ...
                return [
                    [meta.displacement, [meta.vector[0] + meta.displacement[0], meta.vector[1] + meta.displacement[1]]]
                ]
            }
            ...
            module.exports = function(config) {
                ...
                tip.move = function(x0, y0) {
                    ...
                    for (i = 0; i < data.length; i += 1) {
                        if (data[i].skipTip || data[i].parametric || data[i].points || data[i].implicit || data[i].polar || data[i].vector) {
                            continue
                        }
                        var range = data[i].range || [-inf, inf];
                        if (x0 > range[0] - globals.TIP_X_EPS && x0 < range[1] + globals.TIP_X_EPS) {
                            var candidateY = evaluate(data[i], "fn", {
                                x: x0
                            });
                    ...
                    if (closestIndex !== -1) {
                        ...
                        y = evaluate(data[closestIndex], "fn", {
                            x: x
                        });
                        tip.show();
                ...
                function plotLine(selection) {
                    ...
                    selection.each(function(data) {
                        ...
                        innerSelection.each(function() {
                            ...
                            path.attr("stroke-width", minWidthHeight).attr("stroke", utils.color(data, options.index)).attr("opacity", options.closed ? .5 : 1).attr("d", line)
                        });
                        innerSelection.exit().remove()
                    })
                }
            ...
            module.exports = function(options) {
                ...
                function plotLine(selection) {
                    ...
                    selection.each(function(data) {
                        ...
                        var innerSelection = el.selectAll(":scope > path.line").data(evaluatedData);
                        innerSelection.enter().append("path").attr("class", "line line-" + index).attr("stroke-width", 1).attr("stroke-linecap", "round").each(function(d) {
                            var path = d3.select(this);
                            if (data.vector) {
                        ...
                        innerSelection.each(function() {
                            ...
                            path.attr("stroke", color).attr("d", d)
                        });
                        innerSelection.exit().remove()
                    })
                }
        ...
        26: [function(require, module, exports) {
            ...
            "./node/ArrayNode": 29,
            "./node/AssignmentNode": 30,
            "./node/ConditionalNode": 31,
            "./node/ConstantNode": 32,
            "./node/FunctionNode": 33,
            "./node/OperatorNode": 34,
            "./node/SymbolNode": 35,
            "./node/UnaryNode": 36,
            extend: 37
        }],
        ...
        40: [function(require, module, exports) {
            ...
            "./Lexer": 39,
            "./node/ArrayNode": 41,
            "./node/AssignmentNode": 42,
            "./node/BlockNode": 43,
            "./node/ConditionalNode": 44,
            "./node/ConstantNode": 45,
            "./node/FunctionNode": 46,
            "./node/OperatorNode": 48,
            "./node/SymbolNode": 49,
            "./node/UnaryNode": 50,
            "./token-type": 52
        }],
        ...
        59: [function(require, module, exports) {
            ...
            "./lib/double": 61,
            "./lib/interval": 62,
            "./lib/operations/algebra": 63,
            "./lib/operations/arithmetic": 64,
            "./lib/operations/misc": 66,
            "./lib/operations/relational": 67,
            "./lib/operations/trigonometric": 68,
            "./lib/operations/utils": 69,
            "./lib/polyfill": 70,
            "./lib/round-math": 71
        }],
        ...
        75: [function(require, module, exports) {
            ...
            "./node/ArrayNode": 78,
            "./node/AssignmentNode": 79,
            "./node/ConditionalNode": 80,
            "./node/ConstantNode": 81,
            "./node/FunctionNode": 82,
        ...
        88: [function(require, module, exports) {
            ...
            "./Lexer": 87,
            "./node/ArrayNode": 89,
            "./node/AssignmentNode": 90,
            "./node/BlockNode": 91,
            "./node/ConditionalNode": 92,
            "./node/ConstantNode": 93,
            "./node/FunctionNode": 94,
            "./node/OperatorNode": 96,
            "./node/SymbolNode": 97,
            "./node/UnaryNode": 98,
            "./token-type": 100,
            dup: 40
